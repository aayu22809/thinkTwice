    ...
    const handleEmergencyExit = () => {
        if (scenario.isScam) {
            ...
            onEnd({
                ...
                feedback: 'Using the "Exit" button is a great habit. If something feels wrong, stop immediately.',
    ...
    const handleLegitEscapeConfirm = (leave) => {
        ...
        if (leave) {
            ...
            onEnd({
                ...
                feedback: 'You chose to escape. While this scenario was actually safe (legitimate), being cautious is never wrong.',
    ...
    const handleTimeoutAction = (action) => {
        if (action === 'retry') {
            ...
            onEnd({
                ...
                feedback: 'Scammers often use urgency to make you panic. Taking too long is better than rushing, but in this simulation, it counts as a fail.',
    ...
    if (isTimeout) {
        return (
            <div style={{
                ...
                <h1 style={{ color: 'red', fontSize: '3rem' }}>TIME UP</h1>
                <p style={{ fontSize: '1.5rem', maxWidth: '600px', textAlign: 'center' }}>
                    You ran out of time. In real life, taking your time is good, but indecision can sometimes leave you vulnerable.
                </p>
        ...
        return (
            <div style={{
                ...
                <div style={{ backgroundColor: 'white', color: 'black', padding: '40px', borderRadius: '10px', maxWidth: '500px', textAlign: 'center' }}>
                    <h2>Wait!</h2>
                    <p>This situation is actually <strong>legitimate</strong>.</p>
                    <p>However, your caution is valid. If you are ever unsure, leaving is a safe option.</p>
        ...
        <div>
            ...
            <div style={{ borderTop: '2px solid #ccc', paddingTop: '20px', textAlign: 'center' }}>
                <button
                    ...
                    className="btn btn-danger"
                >
                    🚨 I believe this is a scam. Escape now.
                </button>
            </div>
        </div>
    );
